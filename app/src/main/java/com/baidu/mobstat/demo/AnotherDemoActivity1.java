...
public class AnotherDemoActivity1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 设置AppKey
        StatService.setAppKey("d612b8cd7d"); // appkey必须在mtj网站上注册生成，该设置建议在AndroidManifest.xml中填写，代码设置容易丢失
        ...
        btnSetTV.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                StatService.setForTv(AnotherDemoActivity1.this, true);
            }
        });
        ...
        btnPrev.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(AnotherDemoActivity1.this, DemoActivity3.class);

                AnotherDemoActivity1.this.startActivity(intent);
            }
        });
        ...
        btnNext.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(AnotherDemoActivity1.this, DemoActivity2.class);
                AnotherDemoActivity1.this.startActivity(intent);
            }
        });
        ...
        btnWebview.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(AnotherDemoActivity1.this, WebViewActivity.class);
                AnotherDemoActivity1.this.startActivity(intent);
            }
        });
        ...
        btnNativeException.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                // NativeCrashHandler.native_exception();
            }
        });
        ...
        btnEvent.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                StatService.onEvent(AnotherDemoActivity1.this.getApplicationContext(), "registered id", "pass", 1);
            }
        });
        ...
        btnEventDuration.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                StatService.onEventDuration(AnotherDemoActivity1.this, "registered id", "pass", 100);
        ...
        btnEventStart.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                StatService.onEventStart(AnotherDemoActivity1.this, "registered id", "pass"); // 必须和onEventEnd共用才行
        ...
        btnEventEnd.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                // 事件id（"registered id"）的事件pass，其时长持续10毫秒
                StatService.onEventEnd(AnotherDemoActivity1.this, "registered id", "pass"); // 必须和onEventStart共用才行
        ...
        btnFragmentPage.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                in.setClass(AnotherDemoActivity1.this, MainFragmentActivity.class);
                startActivity(in);
            }
        });
        ...
        btnAppFragmentPage.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    Intent in = new Intent();
                    in.setClass(AnotherDemoActivity1.this, AppFragmentDemoActivity.class);
                    startActivity(in);
                }
            }
        });
